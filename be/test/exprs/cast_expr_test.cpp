...
static ColumnPtr make_root_typed_only_variant_bigint_column(const std::vector<int64_t>& values,
    ...
    typed.emplace_back(NullableColumn::create(std::move(data), std::move(null)));
    auto variant = VariantColumn::create();
    variant->set_shredded_columns({""}, {TypeDescriptor(TYPE_BIGINT)}, std::move(typed), nullptr, nullptr);
    return variant;
}
...
static ColumnPtr make_root_typed_only_variant_array_column(const std::vector<DatumArray>& values,
    ...
    MutableColumns typed;
    typed.emplace_back(std::move(array_col));
    auto variant = VariantColumn::create();
    variant->set_shredded_columns({""}, {array_type}, std::move(typed), nullptr, nullptr);
    return variant;
}
...
static ColumnPtr make_base_shredded_root_bigint_variant_column(const std::vector<int64_t>& values,
    ...
    auto typed_nullable = NullableColumn::create(std::move(data), std::move(null));
    ...
    MutableColumns typed;
    typed.emplace_back(std::move(typed_nullable));
    auto variant = VariantColumn::create();
    variant->set_shredded_columns({""}, {TypeDescriptor(TYPE_BIGINT)}, std::move(typed), std::move(metadata),
                                  std::move(remain));
    return variant;
}
...
static ColumnPtr make_root_typed_only_variant_map_column(const std::vector<DatumMap>& values,
    ...
    MutableColumns typed;
    typed.emplace_back(std::move(map_col));
    auto variant = VariantColumn::create();
    variant->set_shredded_columns({""}, {map_type}, std::move(typed), nullptr, nullptr);
    return variant;
}
...
static ColumnPtr make_root_typed_only_variant_struct_column(const std::vector<DatumStruct>& values,
    ...
    MutableColumns typed;
    typed.emplace_back(std::move(struct_col));
    auto variant = VariantColumn::create();
    variant->set_shredded_columns({""}, {struct_type}, std::move(typed), nullptr, nullptr);
    return variant;
}
...
static ColumnPtr make_base_shredded_root_typed_variant_column(const VariantRowValue& typed_variant, size_t rows) {
    ...
    auto variant = VariantColumn::create();
    variant->set_shredded_columns({""}, {TypeDescriptor(TYPE_VARIANT)}, std::move(typed), std::move(metadata),
                                  std::move(remain));
    return variant;
}
