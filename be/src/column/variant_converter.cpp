...
Status VariantConverter::cast_to_bool(const VariantRowValue& variant, ColumnBuilder<TYPE_BOOLEAN>& result) {
...
Status VariantConverter::cast_to_string(const VariantRowValue& variant, const cctz::time_zone& zone,
...
Status VariantConverter::cast_to_date(const VariantRowValue& row, const cctz::time_zone& zone,
...
Status VariantConverter::cast_to_time(const VariantRowValue& row, const cctz::time_zone& zone,
...
Status VariantConverter::cast_to_datetime(const VariantRowValue& row, const cctz::time_zone& zone,
